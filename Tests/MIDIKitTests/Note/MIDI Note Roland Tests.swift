...
final class NoteRolandTests: XCTestCase {
    ...
    func testNoteInit_String() throws {
        ...
        XCTAssertThrowsError(try MIDI.Note("B♯3", style: style)) // don't allow C across different octave
