...
final class NoteCakewalkTests: XCTestCase {
    ...
    func testStringValue() {
        ...
        XCTAssertEqual(MIDI.Note(60, style: style).stringValue(respellSharpAsFlat: true,
                                                               unicodeAccidental: true), "C5")
        
        // respelling and unicode a, style: styleccidental
    ...
    func testNoteInit_String() throws {
        ...
        XCTAssertThrowsError(try MIDI.Note("B♯4", style: style)) // don't allow C across different octave
        XCTAssertThrowsError(try MIDI.Note("C♭4", style: style)) // don't allow B across different octave
