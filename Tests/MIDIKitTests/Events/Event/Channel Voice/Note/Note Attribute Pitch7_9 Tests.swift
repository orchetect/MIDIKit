...
class NoteAttribute_Pitch7_9_Tests: XCTestCase {
    ...
    func testInit_BytePair() {
        ...
        let pitchA = Pitch7_9(MIDI.Byte.Pair(msb: 0b0000_0000, lsb: 0b0000_0000))
        XCTAssertEqual(pitchA.coarse, 0)
        XCTAssertEqual(pitchA.fine, 0)
        
        let pitchB = Pitch7_9(MIDI.Byte.Pair(msb: 0b0000_0010, lsb: 0b0000_0001))
        XCTAssertEqual(pitchB.coarse, 1)
        XCTAssertEqual(pitchB.fine, 1)
        
        let pitchC = Pitch7_9(MIDI.Byte.Pair(msb: 0b1111_1111, lsb: 0b1111_1111))
    ...
    func testBytePair() {
        ...
        XCTAssertEqual(Pitch7_9(coarse:   0, fine:   0).bytePair,
                       .init(msb: 0b0000_0000, lsb: 0b0000_0000))
        
        XCTAssertEqual(Pitch7_9(coarse:   1, fine:   1).bytePair,
                       .init(msb: 0b0000_0010, lsb: 0b0000_0001))
        
        XCTAssertEqual(Pitch7_9(coarse: 127, fine: 511).bytePair,
    ...
    func testInit_UInt16() {
        ...
        let pitchA = Pitch7_9(UInt16(0b0000000_000000000))
        XCTAssertEqual(pitchA.coarse, 0)
        XCTAssertEqual(pitchA.fine, 0)
        
        let pitchB = Pitch7_9(UInt16(0b0000001_000000001))
        XCTAssertEqual(pitchB.coarse, 1)
        XCTAssertEqual(pitchB.fine, 1)
        
        let pitchC = Pitch7_9(UInt16(0b1111111_111111111))
        XCTAssertEqual(pitchC.coarse, 127)
        XCTAssertEqual(pitchC.fine, 511)
    ...
    func testUInt16() {
        ...
        XCTAssertEqual(Pitch7_9(coarse:   0, fine:   0).uInt16Value,
                       0b0000000_000000000)
        
        XCTAssertEqual(Pitch7_9(coarse:   1, fine:   1).uInt16Value,
                       0b0000001_000000001)
        
        XCTAssertEqual(Pitch7_9(coarse: 127, fine: 511).uInt16Value,
                       0b1111111_111111111)
    ...
    func testDouble() {
        ...
        XCTAssertEqual(Pitch7_9(coarse: 0, fine: 0).doubleValue,
                       0.0)
        
        XCTAssertEqual(Pitch7_9(coarse: 1, fine: 256).doubleValue,
                       1.5)
        
        XCTAssertEqual(Pitch7_9(coarse: 127, fine: 0).doubleValue,
                       127.0)
        
        XCTAssertEqual(Pitch7_9(coarse: 127, fine: 511).doubleValue,
                       127.998046875)
