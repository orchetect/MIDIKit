...
final class ChanVoiceValueConversionsTests: XCTestCase {
    ...
    func testScaled_32Bit_from_7Bit() {
        ...
        XCTAssertEqual(MIDI.Event.scaled32Bit(from7Bit:   0), 0x00000000) // min
        XCTAssertEqual(MIDI.Event.scaled32Bit(from7Bit:   1), 0x02000000)
        XCTAssertEqual(MIDI.Event.scaled32Bit(from7Bit:  63), 0x7E000000)
        XCTAssertEqual(MIDI.Event.scaled32Bit(from7Bit:  64), 0x80000000) // midpoint
        XCTAssertEqual(MIDI.Event.scaled32Bit(from7Bit:  65), 0x82082082)
        XCTAssertEqual(MIDI.Event.scaled32Bit(from7Bit: 126), 0xFDF7DF7D)
        XCTAssertEqual(MIDI.Event.scaled32Bit(from7Bit: 127), 0xFFFFFFFF) // max
        
    }
    
    func testScaled_7Bit_from_32Bit() {
        
        XCTAssertEqual(MIDI.Event.scaled7Bit(from32Bit: 0x00000000), 0) // min
        XCTAssertEqual(MIDI.Event.scaled7Bit(from32Bit: 0x02000000), 1)
        XCTAssertEqual(MIDI.Event.scaled7Bit(from32Bit: 0x7E000000), 63)
        XCTAssertEqual(MIDI.Event.scaled7Bit(from32Bit: 0x80000000), 64) // midpoint
        XCTAssertEqual(MIDI.Event.scaled7Bit(from32Bit: 0x82082082), 65)
        XCTAssertEqual(MIDI.Event.scaled7Bit(from32Bit: 0xFDF7DF7D), 126)
        XCTAssertEqual(MIDI.Event.scaled7Bit(from32Bit: 0xFFFFFFFF), 127) // max
    ...
    func testScaled_32Bit_from_14Bit() {
        ...
        XCTAssertEqual(MIDI.Event.scaled32Bit(from14Bit: 0x0000), 0x00000000) // min
        XCTAssertEqual(MIDI.Event.scaled32Bit(from14Bit: 0x1000), 0x40000000)
        XCTAssertEqual(MIDI.Event.scaled32Bit(from14Bit: 0x2000), 0x80000000) // midpoint
        XCTAssertEqual(MIDI.Event.scaled32Bit(from14Bit: 0x3000), 0xC0020010)
        XCTAssertEqual(MIDI.Event.scaled32Bit(from14Bit: 0x3FFF), 0xFFFFFFFF) // max
        
    }
    
    func testScaled_14Bit_from_32Bit() {
        
        XCTAssertEqual(MIDI.Event.scaled14Bit(from32Bit: 0x00000000), 0x0000) // min
        XCTAssertEqual(MIDI.Event.scaled14Bit(from32Bit: 0x40000000), 0x1000)
        XCTAssertEqual(MIDI.Event.scaled14Bit(from32Bit: 0x80000000), 0x2000) // midpoint
        XCTAssertEqual(MIDI.Event.scaled14Bit(from32Bit: 0xC0020010), 0x3000)
        XCTAssertEqual(MIDI.Event.scaled14Bit(from32Bit: 0xFFFFFFFF), 0x3FFF) // max
    ...
    func testScaled_7Bit_UnitInterval_RoundTrip() {
        ...
        for value: MIDI.UInt7 in 0x00...0x7F {
            ...
            let scaledUnitIntervalBackTo7Bit = MIDI.Event.scaled7Bit(fromUnitInterval: scaled7BitToUnitInterval)
    ...
    func testScaled_14Bit_UnitInterval_RoundTrip() {
        ...
        for value: MIDI.UInt14 in 0x0000...0x3FFF {
            ...
            let scaledUnitIntervalBackTo14Bit = MIDI.Event.scaled14Bit(fromUnitInterval: scaled14BitToUnitInterval)
    ...
    func testScaled_16Bit_UnitInterval_RoundTrip() {
        ...
        for value: UInt16 in 0x0000...0xFFFF {
            ...
            let scaledUnitIntervalBackTo16Bit = MIDI.Event.scaled16Bit(fromUnitInterval: scaled16BitToUnitInterval)
    ...
    func testScaled_UnitInterval_from_32Bit() {
        ...
        XCTAssertEqual(MIDI.Event.scaledUnitInterval(from32Bit: 0x00000000), 0.00) // min
        XCTAssertEqual(MIDI.Event.scaledUnitInterval(from32Bit: 0x40000000), 0.25)
        XCTAssertEqual(MIDI.Event.scaledUnitInterval(from32Bit: 0x80000000), 0.50) // midpoint
        XCTAssertEqual(MIDI.Event.scaledUnitInterval(from32Bit: 0xC0000000), 0.7500000001187436)
        XCTAssertEqual(MIDI.Event.scaledUnitInterval(from32Bit: 0xFFFFFFFF), 1.00) // max
        
    }
    
    func testScaled_32Bit_from_UnitInterval() {
        
        XCTAssertEqual(MIDI.Event.scaled32Bit(fromUnitInterval: 0.00), 0x00000000) // min
        XCTAssertEqual(MIDI.Event.scaled32Bit(fromUnitInterval: 0.25), 0x40000000)
        XCTAssertEqual(MIDI.Event.scaled32Bit(fromUnitInterval: 0.50), 0x80000000) // midpoint
        XCTAssertEqual(MIDI.Event.scaled32Bit(fromUnitInterval: 0.7500000001164153), 0xC0000000)
        XCTAssertEqual(MIDI.Event.scaled32Bit(fromUnitInterval: 1.00), 0xFFFFFFFF) // max
    ...
    func testScaled_32Bit_UnitInterval_RoundTrip() {
        ...
        for range in ranges {
            for value: UInt32 in range {
                ...
                let scaledUnitIntervalBackTo32Bit = MIDI.Event.scaled32Bit(fromUnitInterval: scaled32BitToUnitInterval)
    ...
    func testScaled_BipolarUnitInterval_from_32Bit() {
        ...
        XCTAssertEqual(MIDI.Event.scaledBipolarUnitInterval(from32Bit: 0x00000000), -1.0) // min
        XCTAssertEqual(MIDI.Event.scaledBipolarUnitInterval(from32Bit: 0x40000000), -0.5)
        XCTAssertEqual(MIDI.Event.scaledBipolarUnitInterval(from32Bit: 0x80000000),  0.0) // midpoint
        XCTAssertEqual(MIDI.Event.scaledBipolarUnitInterval(from32Bit: 0xC0000000),  0.5000000002328306)
        XCTAssertEqual(MIDI.Event.scaledBipolarUnitInterval(from32Bit: 0xFFFFFFFF),  1.0) // max
        
    }
    
    func testScaled_32Bit_from_BipolarUnitInterval() {
        
        XCTAssertEqual(MIDI.Event.scaled32Bit(fromBipolarUnitInterval: -1.0), 0x00000000) // min
        XCTAssertEqual(MIDI.Event.scaled32Bit(fromBipolarUnitInterval: -0.5), 0x40000000)
        XCTAssertEqual(MIDI.Event.scaled32Bit(fromBipolarUnitInterval:  0.0), 0x80000000) // midpoint
        XCTAssertEqual(MIDI.Event.scaled32Bit(fromBipolarUnitInterval:  0.5000000002328306), 0xC0000000)
        XCTAssertEqual(MIDI.Event.scaled32Bit(fromBipolarUnitInterval:  1.0), 0xFFFFFFFF) // max
