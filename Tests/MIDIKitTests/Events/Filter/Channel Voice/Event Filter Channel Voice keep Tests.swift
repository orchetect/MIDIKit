//
//  Event Filter Channel Voice keep Tests.swift
...
final class MIDIEventFilter_ChannelVoiceKeep_Tests: XCTestCase {
    ...
    func testFilter_keepNotesInRanges_60to60_61to61() {
        ...
        let filteredEvents = events.filter(chanVoice: .keepNotesInRanges([60...60, 61...61]))
