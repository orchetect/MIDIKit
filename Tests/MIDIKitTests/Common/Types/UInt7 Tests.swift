...
//        }
    ...
    func testBinaryInteger_UInt7Exactly() {
        XCTAssertEqual(0b0000000.toMIDIUInt7Exactly, 0b0000000)
        XCTAssertEqual(0b1111111.toMIDIUInt7Exactly, 0b1111111)
    ...
    func testBinaryInteger_Init_UInt7() {
        ...
        XCTAssertEqual(Int(exactly: 0b1111111.toMIDIUInt7), 0b1111111)
    }
