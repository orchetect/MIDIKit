...
//        }
    ...
    func testInitBytePair() {
        XCTAssertEqual(
            MIDI.UInt14(bytePair: MIDI.Byte.Pair(msb: 0x00, lsb: 0x00)).intValue,
            _min
        )
        XCTAssertEqual(
            MIDI.UInt14(bytePair: MIDI.Byte.Pair(msb: 0x40, lsb: 0x00)).intValue,
            _midpoint
        )
        XCTAssertEqual(
            MIDI.UInt14(bytePair: MIDI.Byte.Pair(msb: 0x7F, lsb: 0x7F)).intValue,
            _max
        )
    }
    ...
    func testInitUInt7Pair() {
        XCTAssertEqual(
            MIDI.UInt14(uInt7Pair: MIDI.UInt7.Pair(msb: 0x00, lsb: 0x00)).intValue,
            _min
        )
        XCTAssertEqual(
            MIDI.UInt14(uInt7Pair: MIDI.UInt7.Pair(msb: 0x40, lsb: 0x00)).intValue,
            _midpoint
        )
        XCTAssertEqual(
            MIDI.UInt14(uInt7Pair: MIDI.UInt7.Pair(msb: 0x7F, lsb: 0x7F)).intValue,
            _max
        )
    }
