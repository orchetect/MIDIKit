...
//        }
    ...
    func testBinaryInteger_UInt25Exactly() {
        XCTAssertEqual(
            0b0_0000_0000_0000_0000_0000_0000.toMIDIUInt25Exactly,
            0b0_0000_0000_0000_0000_0000_0000
        )
        XCTAssertEqual(
            0b1_1111_1111_1111_1111_1111_1111.toMIDIUInt25Exactly,
        ...
        XCTAssertNil(0b10_0000_0000_0000_0000_0000_0000.toMIDIUInt25Exactly)
    }
    ...
    func testBinaryInteger_Init_UInt25() {
        ...
        XCTAssertEqual(
            Int(exactly: 0b1_1111_1111_1111_1111_1111_1111.toMIDIUInt25),
            0b1_1111_1111_1111_1111_1111_1111
        )
