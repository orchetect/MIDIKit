...
@Suite struct Event_SequencerSpecific_Tests {
    ...
    @Test
    func init_midi1FileRawBytes_Empty() async throws {
    ...
    @Test
    func midi1FileRawBytes_Empty() async {
    ...
    @Test
    func init_midi1FileRawBytes_OneByte() async throws {
    ...
    @Test
    func midi1FileRawBytes_OneByte() async {
    ...
    @Test
    func midi1FileRawBytes_127Bytes() async {
        let data: [UInt8] = .init(repeating: 0x12, count: 127)
    ...
    @Test
    func midi1FileRawBytes_128Bytes() async {
        let data: [UInt8] = .init(repeating: 0x12, count: 128)
