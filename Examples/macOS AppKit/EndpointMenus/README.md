...
- The menu selections and connections are stored in UserDefaults and restored on app relaunch so the user's selections are remembered.
...
- Maintaining a user's desired selection is remembered even if it disappears from the system.
