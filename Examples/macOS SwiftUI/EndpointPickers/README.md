...
- The SwiftUI views in this example are abstracted in such a way that:
  - The App contains the `MIDIManager` and is capable of restoring saved connections and sending/receiving MIDI. This way it becomes a central service and can be passed into subviews using `.environmentObject(midiManager)`
