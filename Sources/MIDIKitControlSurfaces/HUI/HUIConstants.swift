...
extension HUIConstants {
    public enum kMIDI {
        ...
        // [0x90, 0x00, 0x7F]
        public static let kPingReplyToHostMessage: MIDIEvent = .noteOn(0, velocity: .midi1(0x7F), channel: 0)
        
        public static let kSystemResetMessage: MIDIEvent = .systemReset() // [0xFF]
