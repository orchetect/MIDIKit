...
extension MIDIManager {
    ...
    /// identify the port and reconnect to it, as the port name is not used to identify a MIDI port
    /// since MIDI ports are allowed to have the same name, but must have unique IDs.
    /// >
