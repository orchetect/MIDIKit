...
public typealias MIDICC = MIDIEvent.ChannelVoiceMessage.ControllerChange

// MARK: - MIDIEvent.ChannelVoiceMessage.ControllerChange
...
extension MIDIEvent.ChannelVoiceMessage {
	...
	public enum ControllerChange: Equatable, Hashable {
		...
		case sustainPedal(value: MIDIUInt7)
		
		/// Portamento
		/// (Int: 65, Hex: 0x41)
		///
		/// Values: 0...63 = Off, 64...127 = On.
		case portamento(value: MIDIUInt7)
		...
		case sostenutoPedal(value: MIDIUInt7)
		...
		///
		/// However, some hardware and synths support variably to continuous values 0-127.
		case softPedal(value: MIDIUInt7)
		
		/// Legato Footswitch
		/// (Int: 68, Hex: 0x44)
		///
		/// Values: 0...63 = Normal, 64...127 = Legato.
		case legatoFootswitch(value: MIDIUInt7)
		
		/// Hold 2
		/// (Int: 69, Hex: 0x45)
		///
		/// Values: 0...63 = Off, 64...127 = On.
		case hold2(value: MIDIUInt7)
		
		/// Sound Controller 1 (default: Sound Variation)
		/// (Int: 70, Hex: 0x46)
		case soundCtrl1_soundVariation(value: MIDIUInt7)
		
		/// Sound Controller 2 (default: Timbre/Harmonic Intens.)
		/// (Int: 71, Hex: 0x47)
		case soundCtrl2_timbreIntensity(value: MIDIUInt7)
		
		/// Sound Controller 3 (default: Release Time)
		/// (Int: 72, Hex: 0x48)
		case soundCtrl3_releaseTime(value: MIDIUInt7)
		
		/// Sound Controller 4 (default: Attack Time)
		/// (Int: 73, Hex: 0x49)
		case soundCtrl4_attackTime(value: MIDIUInt7)
		
		/// Sound Controller 5 (default: Brightness)
		/// (Int: 74, Hex: 0x4A)
		case soundCtrl5_brightness(value: MIDIUInt7)
		
		/// Sound Controller 6 (default: Decay Time - see MMA RP-021)
		/// (Int: 75, Hex: 0x4B)
		case soundCtrl6_decayTime(value: MIDIUInt7)
		
		/// Sound Controller 7 (default: Vibrato Rate - see MMA RP-021)
		/// (Int: 76, Hex: 0x4C)
		case soundCtrl7_vibratoRate(value: MIDIUInt7)
		
		/// Sound Controller 8 (default: Vibrato Depth - see MMA RP-021)
		/// (Int: 77, Hex: 0x4D)
		case soundCtrl8_vibratoDepth(value: MIDIUInt7)
		
		/// Sound Controller 9 (default: Vibrato Delay - see MMA RP-021)
		/// (Int: 78, Hex: 0x4E)
		case soundCtrl9_vibratoDelay(value: MIDIUInt7)
		
		/// Sound Controller 10 (default undefined - see MMA RP-021)
		/// (Int: 79, Hex: 0x4F)
		case soundCtrl10_defaultUndefined(value: MIDIUInt7)
		
		/// General Purpose Controller 5
		/// (Int: 80, Hex: 0x50)
		case generalPurpose5(value: MIDIUInt7)
		
		/// General Purpose Controller 6
		/// (Int: 81, Hex: 0x51)
		case generalPurpose6(value: MIDIUInt7)
		
		/// General Purpose Controller 7
		/// (Int: 82, Hex: 0x52)
		case generalPurpose7(value: MIDIUInt7)
		
		/// General Purpose Controller 8
		/// (Int: 83, Hex: 0x53)
		case generalPurpose8(value: MIDIUInt7)
		
		/// Portamento Control
		/// (Int: 84, Hex: 0x54)
		case portamentoControl(value: MIDIUInt7)
		
		// CC 85 ... 87 undefined
		
		/// High Resolution Velocity Prefix
		/// (Int: 88, Hex: 0x58)
		case highResolutionVelocityPrefix(value: MIDIUInt7)
		...
		/// (Int: 91, Hex: 0x5B)
		case effects1Depth_reverbSendLevel(value: MIDIUInt7)
		
		/// Effects 2 Depth (formerly Tremolo Depth)
		/// (Int: 92, Hex: 0x5C)
		case effects2Depth(value: MIDIUInt7)
		
		/// Effects 3 Depth
		/// (default: Chorus Send Level - see MMA RP-023)
		/// (formerly Chorus Depth)
		/// (Int: 93, Hex: 0x5D)
		case effects3Depth_chorusSendLevel(value: MIDIUInt7)
		
		/// Effects 4 Depth
		/// (formerly Celeste [Detune] Depth)
		/// (Int: 94, Hex: 0x5E)
		case effects4Depth(value: MIDIUInt7)
		
		/// Effects 5 Depth
		/// (formerly Phaser Depth)
		/// (Int: 95, Hex: 0x5F)
		case effects5Depth(value: MIDIUInt7)
		...
		case dataIncrement(value: MIDIUInt7? = nil)
		...
		/// Typically this message does not contain a value byte,
		/// so it is recommended to pass `nil`.
		case dataDecrement(value: MIDIUInt7? = nil)
		...
		case raw(_ controller: MIDIUInt7, value: MIDIUInt7)
...
extension MIDIEvent.ChannelVoiceMessage.ControllerChange {
	...
	public func asEvent(channel: MIDIUInt4) -> MIDIEvent {
		...
		MIDIEvent.chanVoice(.cc(self, channel: channel))
...
extension MIDIEvent.ChannelVoiceMessage.ControllerChange {
	...
	public enum Kind: MIDIEventKind, Equatable, Hashable {
		
		case controller(_ number: MIDIUInt7)
