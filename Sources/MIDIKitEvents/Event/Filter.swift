...
extension Collection where Element == MIDI.Event {
	...
	/// Filters voice messages, producing a typed array of `[MIDI.Event.ChannelVoiceMessage]`, which will expose contextual category methods & properties pertaining to Channel Voice messages.
	public func filterChannelVoice() -> [MIDI.Event.ChannelVoiceMessage] {
		
		self.compactMap { item -> MIDI.Event.ChannelVoiceMessage? in
	...
	/// Filters voice messages, producing a typed array of `[MIDI.Event.SystemCommon]`, which will expose contextual category methods & properties pertaining to System Common messages.
	public func filterSystemCommon() -> [MIDI.Event.SystemCommon] {
		
		self.compactMap { item -> MIDI.Event.SystemCommon? in
	...
	/// Filters voice messages, producing a typed array of `[MIDI.Event.SystemRealTime]`, which will expose contextual category methods & properties pertaining to Real Time messages.
	public func filterRealTime() -> [MIDI.Event.SystemRealTime] {
		
		self.compactMap { item -> MIDI.Event.SystemRealTime? in
	...
	/// Filters voice messages, producing a typed array of `[MIDI.Event.SystemExclusive]`, which will expose contextual category methods & properties pertaining to System Exclusive messages.
	public func filterSystemExclusive() -> [MIDI.Event.SystemExclusive] {
		
		self.compactMap { item -> MIDI.Event.SystemExclusive? in
	...
	/// Returns an array of `MIDI.Event`s matching the specified `kinds`.
	public func filter(_ kinds: [MIDIEventKindProtocol]) -> [MIDI.Event] {
		
		guard !kinds.isEmpty else { return [] }
		
		return self.compactMap { item -> MIDI.Event? in
			...
			case .raw:
				return kinds.contains(where: { $0.equals(MIDI.Event.Kind.raw) })
					? item : nil
	...
	/// Returns an array of `MIDI.Event`s matching the specified `pattern`.
	/// - Complexity: O(n) lazily
	public func filter(pattern: [MIDI.Event.KindPattern]) -> [MIDI.Event] {
	...
	/// Returns an array of `MIDI.Event`s excluding events matching the specified `kinds`.
	public func drop(_ kinds: [MIDIEventKindProtocol]) -> [MIDI.Event] {
		
		guard !kinds.isEmpty else {
			// return self without modifying contents

			if let selfArray = self as? [MIDI.Event] {
	...
	/// Returns an array of `MIDI.Event`s excluding events matching the specified `pattern`.
	public func drop(pattern: [MIDI.Event.KindPattern]) -> [MIDI.Event] {
...
extension Collection where Element == MIDI.Event.ChannelVoiceMessage {
	
	/// Returns an array of `MIDI.Event.ChannelVoiceMessage`s matching the specified `pattern`.
	/// Complexity: O(n) lazily
	public func filter(pattern: [MIDI.Event.ChannelVoiceMessage.KindPattern]?) -> [MIDI.Event.ChannelVoiceMessage] {
		...
		return self.compactMap { item -> MIDI.Event.ChannelVoiceMessage? in
...
//		}
	...
	/// Returns an array of `MIDI.Event`s excluding events matching the specified `pattern`.
	public func drop(pattern: [MIDI.Event.ChannelVoiceMessage.KindPattern]) -> [MIDI.Event] {
...
extension Collection where Element == MIDI.Event.ChannelVoiceMessage.ControllerChange {
	
	/// Returns an array of `MIDI.Event.ChannelVoiceMessage`s matching the specified `pattern`.
	/// Complexity: O(n) lazily
	public func filter(pattern: [MIDI.Event.ChannelVoiceMessage.ControllerChange.Kind]?) -> [MIDI.Event.ChannelVoiceMessage.ControllerChange] {
		...
		return self.compactMap { item -> MIDI.Event.ChannelVoiceMessage.ControllerChange? in
...
extension Collection where Element == MIDI.Event.SystemCommon {
...
extension Collection where Element == MIDI.Event.SystemRealTime {
...
extension Collection where Element == MIDI.Event.SystemExclusive {
...
//	public func filterCategory(_ categories: [MIDI.Event.Category]) -> MIDIEventProtocol? {
//		#warning("> code this")
//		return nil
//	}
//
//	/// Exclude events with specified category
//	public func dropCategory(_ categories: [MIDI.Event.Category]) -> MIDIEventProtocol? {
//		#warning("> code this")
//		return nil
//	}
//
//	/// Include only events with specified kind
//	public func filterKind(_ kinds: [MIDI.Event.Kind]) -> MIDIEventProtocol? {
//		#warning("> code this")
//		return nil
//	}
//
//	/// Exclude events with specified kind
//	public func dropKind(_ kinds: [MIDI.Event.Kind]) -> MIDIEventProtocol? {
//		#warning("> code this")
//		return nil
//	}
//
...
//	public static func category(_ categories: [MIDI.Event.Category], include: Bool) -> Self {
//		switch include {
//		case true:
...
//	public static func kind(_ kinds: [MIDI.Event.Kind], include: Bool) -> Self {
//		switch include {
//		case true:
