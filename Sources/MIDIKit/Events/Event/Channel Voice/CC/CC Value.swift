...
extension MIDI.Event.CC.Value: Equatable {
...
extension MIDI.Event.CC.Value {
    
    /// Returns control change value as protocol-agnostic unit interval, converting if necessary.
    ...
    /// Returns velocity as a 7-bit MIDI 1.0 control change value, converting if necessary.
    ...
    /// Returns velocity as a 32-bit MIDI 2.0 control change value, converting if necessary.
