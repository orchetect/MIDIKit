...
extension Collection where Element == MIDI.Event {
    ...
    @inlinable
    public func filter(group: MIDI.UInt4) -> [Element] {
    ...
    @inlinable
    public func filter(groups: [MIDI.UInt4]) -> [Element] {
...
extension Collection where Element == MIDI.Event {
    ...
    @inlinable
    public func drop(group: MIDI.UInt4) -> [Element] {
    ...
    @inlinable
    public func drop(groups: [MIDI.UInt4]) -> [Element] {
