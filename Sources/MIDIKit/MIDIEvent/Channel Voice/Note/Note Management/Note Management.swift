...
extension MIDIEvent.Note.Management {
...
extension Set where Element == MIDIEvent.Note.Management.OptionFlag {
    /// Per-Note Management Option Flag
    /// (MIDI 2.0)
    ///
...
extension MIDIEvent.Note.Management.OptionFlag: CustomStringConvertible {
...
extension Collection where Element == MIDIEvent.Note.Management.OptionFlag {
    public var description: String {
