...
extension MIDIEvent.Note {
    ...
    public struct On {
        ...
        /// Velocity
        @VelocityValidated
        public var velocity: MIDIEvent.Note.Velocity
        ...
        public init(
            note: UInt7,
            velocity: MIDIEvent.Note.Velocity,
            attribute: MIDIEvent.Note.Attribute = .none,
            channel: UInt4,
            group: UInt4 = 0x0,
...
extension MIDIEvent.Note.On: Equatable {
...
extension MIDIEvent.Note.On: Hashable {
