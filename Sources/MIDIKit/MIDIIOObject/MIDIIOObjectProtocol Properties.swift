...
extension MIDIIOObject {
    ...
    public func getName() -> String? {
        try? MIDIKit.getName(of: coreMIDIObjectRef)
    }
    ...
    public func getModel() -> String? {
        try? MIDIKit.getModel(of: coreMIDIObjectRef)
    }
    ...
    public func getManufacturer() -> String? {
        try? MIDIKit.getManufacturer(of: coreMIDIObjectRef)
    }
    ...
    public func getUniqueID() -> MIDIIdentifier {
        MIDIIdentifier(MIDIKit.getUniqueID(of: coreMIDIObjectRef))
    }
    ...
    public func getDeviceManufacturerID() -> Int32 {
        MIDIKit.getDeviceManufacturerID(of: coreMIDIObjectRef)
    }
    ...
    public func getSupportsMMC() -> Bool {
        MIDIKit.getSupportsMMC(of: coreMIDIObjectRef)
    }
    ...
    public func getSupportsGeneralMIDI() -> Bool {
        MIDIKit.getSupportsGeneralMIDI(of: coreMIDIObjectRef)
    }
    ...
    public func getSupportsShowControl() -> Bool {
        MIDIKit.getSupportsShowControl(of: coreMIDIObjectRef)
    }
    ...
    public func getNameConfigurationDictionary() -> NSDictionary? {
        try? MIDIKit.getNameConfigurationDictionary(of: coreMIDIObjectRef)
    }
    ...
    public func getMaxSysExSpeed() -> Int32 {
        MIDIKit.getMaxSysExSpeed(of: coreMIDIObjectRef)
    }
    ...
    public func getDriverDeviceEditorApp() -> URL? {
        try? MIDIKit.getDriverDeviceEditorApp(of: coreMIDIObjectRef)
    }
    ...
    public func getImageFileURL() -> URL? {
        try? MIDIKit.getImage(of: coreMIDIObjectRef)
    }
    ...
    public func getDisplayName() -> String? {
        try? MIDIKit.getDisplayName(of: coreMIDIObjectRef)
    }
    ...
    public func getPanDisruptsStereo() -> Bool {
        MIDIKit.getPanDisruptsStereo(of: coreMIDIObjectRef)
    }
    ...
    public func getProtocolID() -> MIDIProtocolVersion? {
        guard let proto = MIDIKit.getProtocolID(of: coreMIDIObjectRef) else { return nil }
        return .init(proto)
    }
    ...
    public func getTransmitsMTC() -> Bool {
        MIDIKit.getTransmitsMTC(of: coreMIDIObjectRef)
    }
    ...
    public func getReceivesMTC() -> Bool {
        MIDIKit.getReceivesMTC(of: coreMIDIObjectRef)
    }
    ...
    public func getTransmitsClock() -> Bool {
        MIDIKit.getTransmitsClock(of: coreMIDIObjectRef)
    }
    ...
    public func getReceivesClock() -> Bool {
        MIDIKit.getReceivesClock(of: coreMIDIObjectRef)
    }
    ...
    public func getAdvanceScheduleTimeMuSec() -> String? {
        try? MIDIKit.getAdvanceScheduleTimeMuSec(of: coreMIDIObjectRef)
    }
    ...
    public func getIsMixer() -> Bool {
        MIDIKit.getIsMixer(of: coreMIDIObjectRef)
    }
    ...
    public func getIsSampler() -> Bool {
        MIDIKit.getIsSampler(of: coreMIDIObjectRef)
    }
    ...
    public func getIsEffectUnit() -> Bool {
        MIDIKit.getIsEffectUnit(of: coreMIDIObjectRef)
    }
    ...
    public func getIsDrumMachine() -> Bool {
        MIDIKit.getIsDrumMachine(of: coreMIDIObjectRef)
    }
    ...
    public func getIsOffline() -> Bool {
        MIDIKit.getIsOffline(of: coreMIDIObjectRef)
    }
    ...
    public func getIsPrivate() -> Bool {
        MIDIKit.getIsPrivate(of: coreMIDIObjectRef)
    }
    ...
    public func getDriverOwner() -> String? {
        try? MIDIKit.getDriverOwner(of: coreMIDIObjectRef)
    }
    ...
    public func getDriverVersion() -> Int32 {
        MIDIKit.getDriverVersion(of: coreMIDIObjectRef)
    }
    ...
    public func getCanRoute() -> Bool {
        MIDIKit.getCanRoute(of: coreMIDIObjectRef)
    }
    ...
    public func getIsBroadcast() -> Bool {
        MIDIKit.getIsBroadcast(of: coreMIDIObjectRef)
    }
    ...
    public func getConnectionUniqueID() -> MIDIIdentifier {
        MIDIKit.getConnectionUniqueID(of: coreMIDIObjectRef)
    }
    ...
    public func getIsEmbeddedEntity() -> Bool {
        MIDIKit.getIsEmbeddedEntity(of: coreMIDIObjectRef)
    }
    ...
    public func getSingleRealtimeEntity() -> Int32 {
        MIDIKit.getSingleRealtimeEntity(of: coreMIDIObjectRef)
    }
    ...
    public func getReceiveChannels() -> Int32 {
        MIDIKit.getReceiveChannels(of: coreMIDIObjectRef)
    }
    ...
    public func getTransmitChannels() -> Int32 {
        MIDIKit.getTransmitChannels(of: coreMIDIObjectRef)
    }
    
    /// Get the bitmap of channels on which the object transmits messages.
    /// (`kMIDIPropertyMaxReceiveChannels`)
    public func getMaxReceiveChannels() -> Int32 {
        MIDIKit.getMaxReceiveChannels(of: coreMIDIObjectRef)
    }
    ...
    public func getMaxTransmitChannels() -> Int32 {
        MIDIKit.getMaxTransmitChannels(of: coreMIDIObjectRef)
    }
    ...
    public func getReceivesBankSelectLSB() -> Bool {
        MIDIKit.getReceivesBankSelectLSB(of: coreMIDIObjectRef)
    }
    ...
    public func getReceivesBankSelectMSB() -> Bool {
        MIDIKit.getReceivesBankSelectMSB(of: coreMIDIObjectRef)
    }
    ...
    public func getTransmitsBankSelectLSB() -> Bool {
        MIDIKit.getTransmitsBankSelectLSB(of: coreMIDIObjectRef)
    }
    ...
    public func getTransmitsBankSelectMSB() -> Bool {
        MIDIKit.getTransmitsBankSelectMSB(of: coreMIDIObjectRef)
    }
    ...
    public func getReceivesNotes() -> Bool {
        MIDIKit.getReceivesNotes(of: coreMIDIObjectRef)
    }
    ...
    public func getTransmitsNotes() -> Bool {
        MIDIKit.getTransmitsNotes(of: coreMIDIObjectRef)
    }
    ...
    public func getReceivesProgramChanges() -> Bool {
        MIDIKit.getReceivesProgramChanges(of: coreMIDIObjectRef)
    }
    ...
    public func getTransmitsProgramChanges() -> Bool {
        MIDIKit.getTransmitsProgramChanges(of: coreMIDIObjectRef)
    }
}
