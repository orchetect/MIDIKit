...
extension MIDIFileTrackEvent {
    ...
    public struct SMPTEOffset {
        ...
        public var frameRate: MIDIFileFrameRate = .fps30
...
extension MIDIFileTrackEvent.SMPTEOffset: MIDIFileTrackEventPayload {
    ...
    public init(
        ...
        ) = try rawBytes.withDataParser { parser throws(MIDIFileDecodeError) -> (
        ...
        guard let readFrameRate = MIDIFileFrameRate(midi1SMFRawTrackOffsetByte: readFrameRateBits)
        else {
    ...
    static var midi1SMFFixedRawBytesLength: Int { 8 }
...
extension TimecodeFrameRate {
    ...
    /// frame rate.
    public var midiFileSMPTEFrameRate: MIDIFileFrameRate {
        switch self {
