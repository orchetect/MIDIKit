...
public enum MIDIFileFormat: UInt8 {
    /// Type 0:
...
extension MIDIFileFormat: Equatable { }

extension MIDIFileFormat: Hashable { }

extension MIDIFileFormat: CaseIterable { }

extension MIDIFileFormat: Identifiable {
    public var id: Self { self }
}

extension MIDIFileFormat: Sendable { }

extension MIDIFileFormat: CustomStringConvertible {
...
extension MIDIFileFormat: CustomDebugStringConvertible {
