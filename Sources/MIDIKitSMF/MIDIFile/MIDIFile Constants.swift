...
extension MIDIFile {
    static let kChunkMIDITrackEnd: [Byte] = [0xFF, 0x2F, 0x00]

    static let kEventHeaders: [MIDIFileEventType: [Byte]] =
        [
    ...
    static let kTextEventHeaders: [MIDIFileEvent.Text.EventType: [Byte]] =
        [
            .text:                [0xFF, 0x01],
            .copyright:           [0xFF, 0x02],
