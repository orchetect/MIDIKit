...
/// Type representing a 14-bit value (double 7-bit byte)
///
/// Formed as: `(MSB << 7) + LSB` where MSB and LSB are 7-bit values.
public struct MIDIUInt14: MIDIKitInteger {
...
extension MIDIUInt14: ExpressibleByIntegerLiteral {
...
extension MIDIUInt14: Equatable, Comparable {
...
extension BinaryInteger {
	...
	/// Convenience initializer for `MIDIUInt14` as a property.
	public var midiUInt14: MIDIUInt14 {
		MIDIUInt14(self)
	}
