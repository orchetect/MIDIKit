...
extension MIDIEvent {
    ...
    /// (MIDI 1.0 / 2.0)
    ///
    /// This event can optionally contain a Bank Select message. In MIDI 1.0, these will be transmit as separate messages. In MIDI 2.0, this information is all contained within a single packet. See the ``bank-swift.property`` property for more info.
    ///
    /// > MIDI 2.0 Spec:
    /// >
