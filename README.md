...
4. See the [getting started guide](https://swiftpackageindex.com/orchetect/swift-midi/documentation) and the Examples folder within each repository to see the library in action.
...
For new users, see the [getting started guide](https://swiftpackageindex.com/orchetect/swift-midi/documentation) and the Examples folder within each repository to see the library in action.
